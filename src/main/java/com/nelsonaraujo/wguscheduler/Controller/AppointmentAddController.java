...
public class AppointmentAddController {
    ...
    private void addAppointment(){
        ...
        Timestamp startLocalTimeTs = TimeZones.getUtcTime(startTs,timezone);
        Timestamp endLocalTimeTs = TimeZones.getUtcTime(endTs,timezone);

        // Add appointment to database
        Datasource.addAppointment(title,description,location, type, startLocalTimeTs,endLocalTimeTs, customer,contact);
    }
